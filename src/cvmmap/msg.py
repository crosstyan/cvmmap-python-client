...
class ControlErrorCode(IntEnum):
    OK = 0
    UNKNOWN_CMD = 1
    ERROR = 2
    UNSUPPORTED = 3
...
SOURCE_INFO_FLAG_LOOP_EMITS_RESET = 0x00000020
...
class SourceInfo:
    ...
    @property
    def loop_emits_reset(self) -> bool:
        return (self.flags & SOURCE_INFO_FLAG_LOOP_EMITS_RESET) != 0
